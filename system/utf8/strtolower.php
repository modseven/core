...
function _strtolower($str)
{
    ...
    if ($utf8_upper_to_lower === NULL) {
        $utf8_upper_to_lower = [
            ...
            0x042C => 0x044C, 0x1EF2 => 0x1EF3, 0x0048 => 0x0068,
            ...
            0x0426 => 0x0446, 0x00C7 => 0x00E7, 0x03AA => 0x03CA, 0x0421 => 0x0441,
            ...
            0x00D1 => 0x00F1, 0x041D => 0x043D, 0x038C => 0x03CC, 0x00C9 => 0x00E9,
            0x0122 => 0x0123,
        ];
    }
    ...
    foreach ($uni as $i => $iValue) {
        if (isset($utf8_upper_to_lower[$iValue])) {
            $uni[$i] = $utf8_upper_to_lower[$iValue];
        }
    }
